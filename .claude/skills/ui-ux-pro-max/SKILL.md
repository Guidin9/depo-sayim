...
The search script lives inside this skill's own directory. The paths below are relative to the **project root** (`depo-sayim/`) — run them from there, or prefix with the absolute project path:
